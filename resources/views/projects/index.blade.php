                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress" style="height: 10px;">
                                <div class="progress-bar bg-{{ $progressColor }} progress-bar-animated rounded"
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                @forelse ($assignedUsers as $user)
                                    <img src="{{ $user->avatar_url ?? asset('storage/images/default_profile.jpg') }}"
                                        ...
                                        data-toggle="tooltip" title="{{ $user->name }} - {{ $user->task_count }} Tugas"
