...
@section('content')
    ...
    @php
        ...
        $badgeColor = $role === 'admin' ? 'danger' : ($role === 'ketua_tim' ? 'warning' : 'info');
    @endphp
        ...
        <div class="col-md-8">
            ...
            <div class="card profile-card shadow-sm mb-4">
                ...
                <div class="profile-header">
                    ...
                    <h3 class="mt-2 mb-1" style="font-size: 23px; font-weight:800">
                        {{ strtoupper($user->name) }}
                    </h3>

                    @if ($role)
                        <span class="badge badge-{{ $badgeColor }} mb-5" style="font-size: 13px; font-weight:500">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (flashMessage) {
                setTimeout(() => flashMessage.classList.add('fade'), 4000);
            }
        });
    </script>
